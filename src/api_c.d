...
extern (Windows)
{
  int GRBgetattrinfo(GRBmodel *model, char *attrname, int *datatypeP,
  ...
  int  GRBsetdblattrarray(GRBmodel *model, char *attrname, int first,
  ...
  int GRBsetcallbackfunc(GRBmodel *model,
      int function(GRBmodel *model, void *cbdata, int where, void *usrdata)cb,
      void *usrdata);
  int GRBgetcallbackfunc(GRBmodel *model,
      int function(GRBmodel *model, void *cbdata, int where, void *usrdata)*cbP);
  ...
  int  GRBcbcut(void *cbdata, int cutlen, int *cutind, double *cutval,
  ...
  int GRBfeasrelax(GRBmodel *model, int relaxobjtype, int minrelax, double *lbpen,
                   double *ubpen, double *rhspen, double *feasobjP);
  ...
  int  GRBloadmodel(GRBenv *env, GRBmodel **modelP, char *Pname, int numvars,
                    int numconstrs, int objsense, double objcon, double *obj,
                    char *sense, double *rhs, int *vbeg, int *vlen, int *vind,
                    double *vval, double *lb, double *ub, char *vtype,
  ...
  int GRBaddvars(GRBmodel *model, int numvars, int numnz, int *vbeg, int *vind,
                 ...
                 char **varnames);
  int GRBaddconstr(GRBmodel *model, int numnz, int *cind, double *cval, char sense,
                   double rhs, char *constrname);
  int  GRBaddconstrs(GRBmodel *model, int numconstrs, int numnz, int *cbeg, int *cind,
                     double *cval, char *sense, double *rhs, char **constrnames);
  ...
  int GRBloadclientenvadv(GRBenv **envP, char *logfilename, char *computeservers,
      int port, char *password, int priority, double timeout,
      int function(GRBmodel *model, void *cbdata, int where, void *usrdata)cb,
                          void *usrdata);
  ...
  int GRBchangeadminpassword(char *computeServer, int port, char *admin_password,
                             char *new_admin_password);
  ...
  int GRBstrongbranch(GRBmodel *model, int num, int *cand,
...
// TODO: implement
//C     #define MALLOCCB_ARGS size_t size, void *syscbusrdata
//C     #define CALLOCCB_ARGS size_t nmemb, size_t size, void *syscbusrdata
//C     #define REALLOCCB_ARGS void *ptr, size_t size, void *syscbusrdata
//C     #define FREECB_ARGS void *ptr, void *syscbusrdata
//C     #define THREADCREATECB_ARGS void **threadP, void (*start_routine)(void *), void *arg, void *syscbusrdata
//C     #define THREADJOINCB_ARGS void *thread, void *syscbusrdata
// int __stdcall
